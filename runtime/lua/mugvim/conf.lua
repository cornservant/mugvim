...
function M:plugin_vim_table_mode()
    require("mugvim.util"):load_on_ft("plugin:vim-table-mode", { "markdown" }, function()
        ...
        require("which-key").add({
            ...
            { "<localleader>t",    function() vim.cmd("TableModeToggle") end,                                    desc = "Toggle table mode" },

            { "<localleader>x",    function() vim.call("tablemode#spreadsheet#DeleteColumn") end,                desc = "Delete column" },

            { "<localleader>i",    function() vim.call("tablemode#spreadsheet#InsertColumn", 0) end,             desc = "Insert column before" },
            { "<localleader>a",    function() vim.call("tablemode#spreadsheet#InsertColumn", 1) end,             desc = "Insert column after" },

            { "<localleader>h",    function() vim.call("tablemode#spreadsheet#cell#Motion", "h") end,            desc = "Motion left" },
            { "<localleader>j",    function() vim.call("tablemode#spreadsheet#cell#Motion", "j") end,            desc = "Motion down" },
            { "<localleader>k",    function() vim.call("tablemode#spreadsheet#cell#Motion", "k") end,            desc = "Motion up" },
            { "<localleader>l",    function() vim.call("tablemode#spreadsheet#cell#Motion", "l") end,            desc = "Motion right" },

            { "<localleader>?",    function() vim.call("tablemode#spreadsheet#EchoCell") end,                    desc = "Echo cell" },
            { "<localleader>s",    function() vim.call("tablemode#spreadsheet#Sort", "") end,                    desc = "Sort" },

            { "<localleader>f",    function() vim.call("tablemode#spreadsheet#formula#Add") end,                 desc = "Add Formula" },
            { "<localleader><cr>", function() vim.call("tablemode#spreadsheet#formula#EvaluateFormulaLine") end, desc = "Evaluate formula line" },

            { "<localleader>=",    function() vim.call("tablemode#table#Realign", ".") end,                      desc = "Realign" },
        })
    end)
end
